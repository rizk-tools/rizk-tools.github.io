...
<div class="newsletter-form-container">
	...
	>
		...
		><button
			...
			style="background: rgb(13, 148, 136); font-size: 14px; color: rgb(255, 255, 255); sans-serif; display: none; width: min-content; max-width: 300px; white-space: nowrap; height: 38px; align-items: center; justify-content: center; flex-direction: row; padding: 9px 17px; box-shadow: rgba(0, 0, 0, 0.05) 0px 1px 2px; border-radius: 6px; text-align: center; font-style: normal; font-weight: 500; line-height: 20px; border: none; cursor: pointer;"
			>Please wait...</button
		>
	</form>
	<div
	...
	>
		<p class="newsletter-success-message" style="sans-serif; color: rgb(0, 0, 0); font-size: 14px;">
	...
	<button
		...
		type="button"
		style="color:#6b7280;font: 14px, sans-serif;margin:10px auto;text-align:center;display:none;background:transparent;border:none;cursor:pointer"
	>
		&larr; Back
	</button>
</div>
